...
<div id="id01" class="modal">
  ...
  <form:form class="modal-content animate" action="${pageContext.request.contextPath}/SaveS" method="POST" modelAttribute="showDTO">
		...
		<form:radiobutton name="showType" path="ShowType" value="3D SUB"/><label>3D SUB</label><br>
		<form:radiobutton name="showType" path="ShowType" value="2D DOB"/><label>2D DOB</label><br>
		<form:radiobutton name="showType" path="ShowType" value="3D DOB"/><label>3D DOB</label><br>
		<form:radiobutton name="showType" path="ShowType" value="2D SUB"/><label>2D SUB</label><br>
