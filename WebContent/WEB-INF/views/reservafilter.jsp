...
<h1>Trailer</h1>
 ...
 <form  name="back" action="${pageContext.request.contextPath}/agregarreservafilter" method="post">
  ...
  <select name="tipo" class="browser-default custom-select" style="width:100%; color: #fff; background: #424ABC; font-size: 20px; height: 50px; border-color: #000; border-width: 2px;">
 	...
 	<div style="flex:33%; margin-left:10px; margin-right:10px;">
 	<select name="fec" class="browser-default custom-select" style="width:100%; color: #fff; background: #424ABC; font-size: 20px; height: 50px; border-color: #000; border-width: 2px;">
